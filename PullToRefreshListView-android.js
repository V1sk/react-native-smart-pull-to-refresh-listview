...
class PullToRefreshListView extends Component {
                ...
                {this.props.viewType == viewType.scrollView ?
                    ...
                    <ListView
                        ...
                        renderScrollComponent={props => <ScrollView
                            ref={(component) => this._innerScrollView = component} {...props} />}/>}
    ...
    _onSwipe = (movement) => {
        ...
        let {
            refresh_none, refresh_idle, will_refresh, refreshing,
    ...
    _resetHeaderLayout = (timestamp) => {
        ...
        let {pullDownStayDistance, dataSource, renderSectionHeader, listSectionProps, resetLoadMoreState} = this.props
        let headerHeight
        if (!this._beginTimeStamp) {
            headerHeight = pullDownStayDistance
            this._beginTimeStamp = timestamp
